...
As the effect size increases, the power increases.  Since the standard deviation is the same for the datasets for each mu, the only part of the effect size that is changing is the difference between the actual mu and the null mu.  As the difference between the null mu (0) and the actual mu, the power also increases.
